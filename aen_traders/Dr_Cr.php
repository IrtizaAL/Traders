...
<html>
    ...
    <body>
     ...
     <form method="post" action="submitaction.php" enctype='multipart/form-data'>
        ...
        <button name="import1">Upload</button>
            </form>
              </div> 
              <div class="col-sm-3"></div>
          </div>        
...
if(isset($_POST['import']))
{
    ...
    if($_FILES["file"]["size"] > 0)
    {
        ...
        while (($col = fgetcsv($file, 10000, ",")) !== FALSE) 
        {
          ...
          $enter = "INSERT INTO Dr_Cr(`customer`, `order`, `date`, `account due`, `days outstanding`, `not due`, `0-30 days`, `31-60 days`, `>90 days`) VALUES ('".$col[0]."','".$col[1]."','".$col[2]."')";
